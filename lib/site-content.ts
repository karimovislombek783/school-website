...
export const siteIdentity = {
  ...
  established: "Tasdiqlanmoqda / To be confirmed",
  ...
  activityAddresses: [
    ...
    "Xorazm viloyati, Hazorasp tumani, Ziyolilar MFY, Istiqlol ko‘chasi, 272-uy",
  ],
  license: "531978",
...
export const copy = {
  uz: {
    ...
    home: {
      ...
      pillarsTitle: "Ta’limga yondashuv", pillarsIntro: "Bilim, mas’uliyat va o‘quvchining izchil rivojlanishiga qaratilgan ta’lim muhiti.",
    ...
    pages: {
      ...
      academics: { eyebrow: "Ta’lim", title: "I–XI sinflar uchun ta’lim", intro: "Maktab O‘zbekiston milliy o‘quv dasturi asosida I–XI sinf bosqichlarida ta’lim beradi. Fanlar va yo‘nalishlar haqidagi batafsil ma’lumotlar tasdiqlangach qo‘shiladi." },
  ...
  en: {
    ...
    home: {
      ...
      pillarsTitle: "Our approach to education", pillarsIntro: "A learning environment centred on knowledge, responsibility and consistent student development.",
    ...
    pages: {
      ...
      academics: { eyebrow: "Academics", title: "Education for Grades 1–11", intro: "The school provides education across Grades 1–11 in accordance with Uzbekistan’s national curriculum. Detailed subject and programme information will be added after confirmation." },
